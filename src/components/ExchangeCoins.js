...
export const ExchangeCoins = () => {
...
}, [exchangeData.coinList.length , dispatch]);
  ...
  return (
    <div className="px-4 py-4 font-body bg-white bg-opacity-10 backdrop-blur-md rounded-lg border border-black-400 shadow-lg items-center">
    ...
    <div className="flex flex-row mt-8">
        <div className="pr-4 items-center">
            <div className="flex my-1 content-center items-center py-1 px-2 lg:ml-3">
                <p className="text-red-600 font-bold mr-4 text-xs">Sell</p>
                <select
                ...
                <p className="text-green-400 font-bold mr-4 text-xs">Buy</p>
                <select
        ...
        <div className="-mt-5 mr-3 lg:pl-10">
            <div>
                ...
                <input
                    type="number"
                    className="appearance-none block w-full bg-gray-100 bg-opacity-20 backdrop-blur-md text-black leading-tight focus:outline-none focus:bg-gray-400 focus:border-gray-500 rounded border border-gray-400 px-3 py-1 text-sm outline-none pt-2 pb-2"
                    placeholder=""
                    value={text1 || ""}
    ...
    <div className="text-center mt-4 pb-4">
        <button onClick={() => convert()} className="bg-gray-500 background-opacity-10 backdrop-blur-md rounded-lg text-sm py-2 px-6 text-black font-semibold hover:bg-gray-600 border border-white">
            Exchange
        </button>
    </div>
</div>
