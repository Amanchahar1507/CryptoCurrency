...
export const CryptoChart = () => {
  ...
  return (
    <div className="container-fluid w-full h-96 border border-black bg-white bg-opacity-10 backdrop-blur-md my-5 rounded-lg shadow-sm px-4 pt-3 lg:mt-3">
      ...
      <div className="flex lg:gap-3 absolute items-center lg:ml-48 md:ml-16 sm:ml-28 ml-16 gap-2 lg:left-34 left-4 md:mt-3 lg:mt-3 sm:mt-3 mt-3">
        ...
        <button
          ...
          } rounded-md text-xs text-black bg-white bg-opacity-30 backdrop-blur-md font-semibold lg:mt-2`}
          onClick={oneDay}
        >
          1D
        </button>
        ...
        <button
          ...
          } rounded-md text-xs bg-white font-semibold lg:mt-2 text-black bg-opacity-30 backdrop-blur-md`}
        >
          1W
        </button>
        <button
        ...
        <div className="flex absolute items-center rounded-md bg-black border-black text-black bg-opacity-30 backdrop-blur-md p-2 w-24 lg:left-[16rem] lg:mt-4 md:left-[25rem] md:mt-4 sm:right-[9rem] mt-20 ml-2">
          <select
            onChange={(e) => {
