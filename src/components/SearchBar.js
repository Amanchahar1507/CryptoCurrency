        ...
        <div className="flex flex-grow rounded-sm shadow-md">
          <div className="flex flex-grow items-center text-black">
            ...
            <input
              ...
              className="flex border border-black shadow-lg focus:ring-1 bg-white bg-opacity-10 backdrop-blur-md
          ...
          {searchData ? (
            searchData.map((coin) => {
              return (
                ...
                >
                  <img className="w-[1rem] h-[1rem] mx-1.5" src={coin.thumb} alt=""/>
            ...
            <div className="w-full h-full mt-8 flex justify-center items-center">
              <div
                className="w-8 h-8 flex border-4 border-black rounded-full border-b-black animate-spin"
                role="status"
              />
      ...
      <div className="flex">
        <span className="flex shadow-md rounded-lg">
          ...
          >
            ...
            <option className="text-black" value={"jpy"}>JPY</option>
            <option className="text-black" value={"aud"}>AUD</option>
            <option className="text-black" value={"nzd"}>NZD</option>
